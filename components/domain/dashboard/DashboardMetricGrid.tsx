...
const METRIC_DEFS: Array<{ key: string; label: string; href?: string }> = [
  ...
  { key: "openActionCount", label: "待处理行动项", href: "/actions" },
  { key: "overdueActionCount", label: "逾期行动项" },
  { key: "highPriorityActionCount", label: "高优先级行动项" },
  { key: "dueTodayActionCount", label: "今日到期行动项" },
