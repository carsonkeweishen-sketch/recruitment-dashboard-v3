...
async function main() {
  ...
  const jobs = await Promise.all([
    prisma.job.create({
      data: {
        title: "KA大客户销售", departmentId: deptSales.id, level: "S4", status: "open", priority: "high",
    ...
    prisma.job.create({
      data: {
        title: "采购资源开发", departmentId: deptScm.id, level: "S3", status: "open", priority: "high",
    ...
    prisma.job.create({
      data: {
        title: "媒介投放", departmentId: deptContent.id, level: "S3", status: "open", priority: "normal",
    ...
    prisma.job.create({
      data: {
        title: "直播场控", departmentId: deptEcomm.id, level: "A2", status: "open", priority: "normal",
    ...
    prisma.job.create({
      data: {
        title: "内容编辑", departmentId: deptContent.id, level: "A3", status: "open", priority: "normal",
        ownerId: userRecruiter.id, businessOwnerId: userInterviewer.id, location: "深圳", headcount: 2,
    ...
    prisma.job.create({
      data: {
        title: "品牌策划", departmentId: deptBrand.id, level: "S4", status: "open", priority: "high",
    ...
    prisma.job.create({
      data: {
        title: "OEM采购", departmentId: deptScm.id, level: "S3", status: "open", priority: "normal",
        ownerId: userRecruiter.id, businessOwnerId: userBiz.id, location: "深圳", headcount: 1,
    ...
    prisma.job.create({
      data: {
        title: "抖音主播", departmentId: deptEcomm.id, level: "A2", status: "open", priority: "high",
