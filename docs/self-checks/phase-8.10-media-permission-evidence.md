# Phase 8.10 Audio/Video/Speech Intelligence Foundation — 权限验证证据
...
| 26 | unauthorized | — | GET /api/speech/media-assets | MediaAsset | — | — | 401 | Unauthorized | 否 | 否 | ✅ |
| 27 | unauthorized | — | GET /api/speech/transcripts/txn-001 | Transcript | txn-001 | — | 401 | Unauthorized | 否 | 否 | ✅ |
| 28 | unauthorized | — | POST /api/speech/transcripts/import | Transcript | — | — | 401 | Unauthorized | 否 | 否 | ✅ |
